...
<h3 align="center">Full Stack Software Engineer (3+ years) building scalable web and mobile applications using Laravel, React, NodeJsandReact Native. Experienced in Database technologies including PostgreSQL, MySQL and Oracle, as well as Pythonandcloud-based infrastructure such as AWS. Skilled in RESTful API Development, containerized deployment withDockerandVersion Control using Git. Adept at achieving high system uptime, optimizing performance and integrating AI andLLM-based automation. Seeking to leverage my expertise in team-oriented environments to build cutting-edgeapplications.</h3>
